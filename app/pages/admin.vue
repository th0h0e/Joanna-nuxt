...
<template>
  <div class="min-h-screen p-6 md:p-8 lg:p-12">
    <!-- Header -->
    <div class="mb-8">
      <h1 class="text-3xl font-bold mb-2">Portfolio Admin Dashboard</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
      <div class="flex items-center justify-between mb-6">
        ...
        <UButton color="primary" size="sm">Add New Project</UButton>
      </div>
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <div class="flex items-center gap-3">
            <UBadge :color="getStatusColor(project.status)" variant="subtle">
              {{ project.status }}
            </UBadge>
